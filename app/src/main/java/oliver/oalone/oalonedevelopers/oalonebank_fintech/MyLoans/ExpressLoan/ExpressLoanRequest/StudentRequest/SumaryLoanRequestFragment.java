...
public class SumaryLoanRequestFragment extends Fragment {
    ...
    ImageView imgSchoolInfoChecked,imgLightAndWasterReceiptChecked,imgProofOfRegistration,imgPayStubs;
    DecimalFormat decimalFormat,decimalFormat2;
    boolean simulation_data,school_data,light_and_water_files,proof_of_registration_files, pay_stubs_files;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_sumary_loan_request, container, false);
        ...
        imgSchoolInfoChecked = view.findViewById(R.id.imgSchoolInfoChecked);
        ...
        userRef.child("Loans Request").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("express_loan").hasChild("School Information")) {

                    if (dataSnapshot.child("express_loan").child("School Information").hasChild("school_cycle") && dataSnapshot.child("express_loan").child("School Information").hasChild("school_degree")
                            && dataSnapshot.child("express_loan").child("School Information").hasChild("school_email") && dataSnapshot.child("express_loan").child("School Information").hasChild("school_name")) {

                        imgSchoolInfoChecked.setImageResource(R.drawable.transaction_completed);
                        school_data = true;

                    } else {
                        imgSchoolInfoChecked.setImageResource(R.drawable.transaction_in_progress);
                        school_data = false;
                    }
                ...
                if (dataSnapshot.child("express_loan").hasChild("Proof of Registration")) {

                    imgProofOfRegistration.setImageResource(R.drawable.transaction_completed);
                    long num_of_files = dataSnapshot.child("express_loan").child("Proof of Registration").getChildrenCount();
                ...
                if (dataSnapshot.child("express_loan").hasChild("Pay Stubs")) {

                    imgPayStubs.setImageResource(R.drawable.transaction_completed);
                    long num_of_files = dataSnapshot.child("express_loan").child("Pay Stubs").getChildrenCount();
        ...
        btnSenRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (school_data = false) {
                    Snackbar.make(rootLayout, "Debes completar la información necesaria sobre la institución educativa", Snackbar.LENGTH_LONG).show();
                }
