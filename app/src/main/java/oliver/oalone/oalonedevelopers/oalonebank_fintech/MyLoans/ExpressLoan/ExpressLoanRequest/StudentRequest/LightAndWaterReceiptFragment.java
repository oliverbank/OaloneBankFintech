...
public class LightAndWaterReceiptFragment extends Fragment {

    Button btnUploadFiles,btnContinue;
    RecyclerView recyclerView;
    static final int RESULT_LOAD_IMAGE = 1;
    StorageReference mStorage;
    String downloadUrl, currentUid,user_condition;
    FirebaseAuth mAuth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_light_and_water_receipt, container, false);
    ...
    private void showFiles() {
        Query query = expressLoanRef.child("Light & Water Receipt").orderByChild("file_name");
        FirebaseRecyclerAdapter<FileUploadedModel, myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FileUploadedModel, myPostViewHolder>
            ...
            protected void populateViewHolder(myPostViewHolder viewHolder, FileUploadedModel model, int position) {
                ...
                viewHolder.btnDeleteFile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        expressLoanRef.child("Light & Water Receipt").child(postKey).removeValue();
                    }
                });
                    ...
                    fileToUpload.putFile(fileUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                expressLoanRef.child("Light & Water Receipt").child("file"+value).child("url").setValue(downloadUrl);
                                expressLoanRef.child("Light & Water Receipt").child("file"+value).child("file_name").setValue(filename);
