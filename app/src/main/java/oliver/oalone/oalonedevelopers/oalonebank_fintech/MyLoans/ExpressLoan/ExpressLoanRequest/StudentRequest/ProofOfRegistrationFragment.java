...
public class ProofOfRegistrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_proof_of_registration, container, false);
    ...
    private void showFiles() {
        Query query = expressLoanRef.child("Proof of Registration").orderByChild("file_name");
        FirebaseRecyclerAdapter<FileUploadedModel, LightAndWaterReceiptFragment.myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FileUploadedModel, LightAndWaterReceiptFragment.myPostViewHolder>
                (FileUploadedModel.class,R.layout.loan_request_file_item, LightAndWaterReceiptFragment.myPostViewHolder.class,query) {
            @Override
            protected void populateViewHolder(LightAndWaterReceiptFragment.myPostViewHolder viewHolder, FileUploadedModel model, int position) {
                ...
                viewHolder.btnDeleteFile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        expressLoanRef.child("Proof of Registration").child(postKey).removeValue();
                    }
                });
            }
        };
                    ...
                    fileToUpload.putFile(fileUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                expressLoanRef.child("Proof of Registration").child("file"+value).child("url").setValue(downloadUrl);
                                expressLoanRef.child("Proof of Registration").child("file"+value).child("file_name").setValue(filename);
