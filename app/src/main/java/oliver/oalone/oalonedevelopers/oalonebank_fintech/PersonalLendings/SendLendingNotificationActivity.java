...
import oliver.oalone.oalonedevelopers.oalonebank_fintech.Companies.FinanceMyCompanyActivity;
...
public class SendLendingNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_lending_notification);
        ...
        userRef.child(receiverUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Picasso.with(SendLendingNotificationActivity.this).load(profileimage).fit().centerCrop().into(profileImage);
        ...
        spinnerMonths = new SpinnerDialog(SendLendingNotificationActivity.this,months,"Selecciona el número de meses para el préstamo");
        spinnerMonths.bindOnSpinerListener(new OnSpinerItemClick() {
            @Override
            public void onClick(String item, int position) {
                btnMonths.setText(item);
                Toast.makeText(SendLendingNotificationActivity.this, "Seleccionado: "+item, Toast.LENGTH_SHORT).show();
            }
        });

        spinnerMonths2 = new SpinnerDialog(SendLendingNotificationActivity.this,months2,"Selecciona el número de meses para el préstamo");
        ...
        spinnerMonths3 = new SpinnerDialog(SendLendingNotificationActivity.this,months3,"Selecciona el número de meses para el préstamo");
        ...
        spinnerGracePeriod = new SpinnerDialog(SendLendingNotificationActivity.this,graceMonths,"Selecciona el número de meses para el período de gracia");
        ...
        spinnerFrecuency = new SpinnerDialog(SendLendingNotificationActivity.this,frecuency,"Selecciona la frecuencia de pago");
    ...
    private void goToSumaryActivity() {
        ...
        Intent intent = new Intent(SendLendingNotificationActivity.this, PersonalLendingSumaryActivity.class);
