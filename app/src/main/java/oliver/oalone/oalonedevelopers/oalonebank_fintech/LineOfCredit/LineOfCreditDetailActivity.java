...
public class LineOfCreditDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_of_credit_detail);
        ...
        btnUseCreditPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LineOfCreditDetailActivity.this, LineOfCreditUseActivity.class);
        ...
        btnPayLineOfCredit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LineOfCreditDetailActivity.this, LineOfCreditPayActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnSchedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LineOfCreditDetailActivity.this, LineOfCreditScheduleActivity.class);
                startActivity(intent);
            }
        });
        ...
        FirebaseRecyclerAdapter<MyOperationsModel, myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<MyOperationsModel, myPostViewHolder>
            ...
            protected void populateViewHolder(myPostViewHolder viewHolder, MyOperationsModel model, int position) {
                ...
                if (viewHolder.operation_code.equals("CL"))
                {
                    ...
                    viewHolder.txtSymbol.setTextColor(ContextCompat.getColor(LineOfCreditDetailActivity.this, R.color.redColor));
                    viewHolder.txtAmount.setTextColor(ContextCompat.getColor(LineOfCreditDetailActivity.this, R.color.redColor));
                }
                if (viewHolder.operation_code.equals("PC"))
                {
                    ...
                    viewHolder.txtSymbol.setTextColor(ContextCompat.getColor(LineOfCreditDetailActivity.this, R.color.greenColor));
                    viewHolder.txtAmount.setTextColor(ContextCompat.getColor(LineOfCreditDetailActivity.this, R.color.greenColor));
                }
