...
public class CompaniesForFactoringRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_companies_for_factoring_request);
    ...
    private void displayAllFinanceRequests() {
        ...
        FirebaseRecyclerAdapter<FactoringFinanceRequestModel, InvestorsFragment.PostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FactoringFinanceRequestModel, InvestorsFragment.PostViewHolder>
                (FactoringFinanceRequestModel.class, R.layout.factoring_finance_request_item, InvestorsFragment.PostViewHolder.class, showPostMostRecentOrder) {
            @Override
            protected void populateViewHolder(final InvestorsFragment.PostViewHolder viewHolder, FactoringFinanceRequestModel model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(CompaniesForFactoringRequestActivity.this,FactoringRequestDetailActivity.class);
