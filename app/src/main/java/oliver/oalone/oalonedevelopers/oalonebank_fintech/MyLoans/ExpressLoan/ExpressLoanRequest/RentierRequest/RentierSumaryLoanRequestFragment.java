...
public class RentierSumaryLoanRequestFragment extends Fragment {

    TextView txtLoanAmount,txtMonths,txtGracePeriod,txtLightAndWaterFilesCount,txtProofOfRegistrationFiles,txtPayStubsFiles,txtTaxPaymentFiles;
    FirebaseAuth mAuth;
    String currentUid,saveCurrentDate,saveCurrentTime,randomName;
    DatabaseReference userRef, fromPath, toPath;
    ImageView imgTaxPayment,imgLightAndWasterReceiptChecked,imgProofOfRegistration,imgPayStubs;
    DecimalFormat decimalFormat,decimalFormat2;
    boolean simulation_data,light_and_water_files,proof_of_registration_files, pay_stubs_files,taxes_payment_files;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rentier_sumary_loan_request, container, false);
        ...
        txtTaxPaymentFiles = view.findViewById(R.id.txtTaxPaymentFiles);
        ...
        imgTaxPayment = view.findViewById(R.id.imgTaxPayment);
        ...
        userRef.child("Loans Request").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("express_loan").hasChild("Rentier Contracts")) {

                    imgPayStubs.setImageResource(R.drawable.transaction_completed);
                    long num_of_files = dataSnapshot.child("express_loan").child("Rentier Contracts").getChildrenCount();
                ...
                if (dataSnapshot.child("express_loan").hasChild("Taxes Payment")) {

                    imgTaxPayment.setImageResource(R.drawable.transaction_completed);
                    long num_of_files = dataSnapshot.child("express_loan").child("Taxes Payment").getChildrenCount();
                    txtTaxPaymentFiles.setText(num_of_files+" Archivos cargados");
                    taxes_payment_files = true;

                } else {
                    imgTaxPayment.setImageResource(R.drawable.transaction_in_progress);
                    taxes_payment_files = false;
                }
        ...
        btnSenRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (taxes_payment_files = false) {
