...
public class PhoneAuthVeryficationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_auth_veryfication);
    ...
    private  PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(PhoneAuthVeryficationActivity.this, e.getMessage()+"", Toast.LENGTH_SHORT).show();
    ...
    private void signInTheUserByCredentials(PhoneAuthCredential credential) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(PhoneAuthVeryficationActivity.this,new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Intent intent = new Intent(PhoneAuthVeryficationActivity.this, PinActivity.class);
                    startActivity(intent);

                } else {
                    Toast.makeText(PhoneAuthVeryficationActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }*/
