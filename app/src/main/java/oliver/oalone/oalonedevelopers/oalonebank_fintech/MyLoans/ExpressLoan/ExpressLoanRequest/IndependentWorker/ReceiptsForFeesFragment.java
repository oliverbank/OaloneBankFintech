...
public class ReceiptsForFeesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_receipts_for_fees, container, false);
    ...
    private void showFiles() {
        Query query = expressLoanRef.child("Receipts Fees").orderByChild("file_name");
        FirebaseRecyclerAdapter<FileUploadedModel, myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FileUploadedModel, myPostViewHolder>
            ...
            protected void populateViewHolder(myPostViewHolder viewHolder, FileUploadedModel model, int position) {
                ...
                viewHolder.btnDeleteFile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        expressLoanRef.child("Receipts Fees").child(postKey).removeValue();
                    }
                });
            }
        };
                    ...
                    fileToUpload.putFile(fileUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                expressLoanRef.child("Receipts Fees").child("file"+value).child("url").setValue(downloadUrl);
                                expressLoanRef.child("Receipts Fees").child("file"+value).child("file_name").setValue(filename);
