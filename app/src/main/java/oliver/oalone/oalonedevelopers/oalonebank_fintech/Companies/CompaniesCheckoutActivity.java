...
public class CompaniesCheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_companies_checkout);
        ...
        companiesRef.child(company_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Picasso.with(CompaniesCheckoutActivity.this).load(company_image).fit().centerCrop().into(profileImage);
                    ...
                    Intent intent = new Intent(CompaniesCheckoutActivity.this,RegisterTransferActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent = new Intent(CompaniesCheckoutActivity.this, FinishCheckoutActivity.class);
