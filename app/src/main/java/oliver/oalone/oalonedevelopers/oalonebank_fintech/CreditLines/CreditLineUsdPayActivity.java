...
public class CreditLineUsdPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_line_usd_pay);
                ...
                oliverBankRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            credit_line_to_chage_now = dataSnapshot.child("Credit Line Amount to Charge Now USD").getValue().toString();
        ...
        userRef.child(currentUserID).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if (task.isSuccessful())
                {
                    ...
                    oliverBankRef.child("Credit Line Amount to Charge Now USD").setValue(real_amount_tocharge_st);
                    registerOperation();
                }
            }
        });
    ...
    private void registerOperation() {
        ...
        myOperationsRef.child(currentUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            @Override
            public void onComplete(@NonNull Task task) {
                Intent intent = new Intent(CreditLineUsdPayActivity.this, InvesmentFundTransactionCompletedActivity.class);
