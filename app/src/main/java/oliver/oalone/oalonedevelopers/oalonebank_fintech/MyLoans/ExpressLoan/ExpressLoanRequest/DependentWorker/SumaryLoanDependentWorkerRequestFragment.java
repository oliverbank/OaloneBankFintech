package oliver.oalone.oalonedevelopers.oalonebank_fintech.MyLoans.ExpressLoan.ExpressLoanRequest.DependentWorker;
...
public class SumaryLoanDependentWorkerRequestFragment extends Fragment {

    TextView txtLoanAmount,txtMonths,txtGracePeriod,txtLightAndWaterFilesCount,txtPayStubsFiles;
    FirebaseAuth mAuth;
    String currentUid,saveCurrentDate,saveCurrentTime,randomName;
    DatabaseReference userRef, fromPath, toPath;
    ImageView imgLightAndWasterReceiptChecked,imgPayStubs;
    DecimalFormat decimalFormat,decimalFormat2;
    boolean simulation_data,light_and_water_files, pay_stubs_files;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sumary_loan_dependent_worker_request, container, false);
        ...
        fromPath.child("user_condition").setValue("dependent_worker");
        ...
        userRef.child("Loans Request").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("express_loan").hasChild("Job Incomes")) {

                    imgPayStubs.setImageResource(R.drawable.transaction_completed);
                    long num_of_files = dataSnapshot.child("express_loan").child("Job Incomes").getChildrenCount();
