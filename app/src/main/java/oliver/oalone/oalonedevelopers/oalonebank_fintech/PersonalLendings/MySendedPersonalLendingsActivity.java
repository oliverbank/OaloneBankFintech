...
public class MySendedPersonalLendingsActivity extends AppCompatActivity {

    RecyclerView myPostList;
    private FirebaseAuth mAuth;
    private DatabaseReference postsRef,userRef,myOperationsRef,imageResourses,ratesRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_sended_personal_lendings);
        ...
        btnMyLendings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MySendedPersonalLendingsActivity.this, SearchUserForLendingActivity.class);
        ...
        FirebaseRecyclerAdapter<PersonalLendingModel, myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<PersonalLendingModel, myPostViewHolder>
            ...
            protected void populateViewHolder(final myPostViewHolder viewHolder, PersonalLendingModel model, final int position) {
                ...
                userRef.child(viewHolder.receiver_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Picasso.with(MySendedPersonalLendingsActivity.this).load(profileimage).fit().centerCrop().into(viewHolder.imageUser);
                ...
                viewHolder.btnShowBills.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(MySendedPersonalLendingsActivity.this, PersonalLendingBillsToChargeActivity.class);
                ...
                viewHolder.btnShowDetails.setOnClickListener(new View.OnClickListener() {
                    ...
                    private void showDetailsDialog() {
                        final AlertDialog.Builder dialog = new AlertDialog.Builder(MySendedPersonalLendingsActivity.this);
                        dialog.setCancelable(false);

                        LayoutInflater inflater = LayoutInflater.from(MySendedPersonalLendingsActivity.this);
