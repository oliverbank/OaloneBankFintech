...
public class LineOfCreditUseUsdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_of_credit_use_usd);
        ...
        spinnerQuotes = new SpinnerDialog(LineOfCreditUseUsdActivity.this,quotes,"Selecciona el número de cuotas");
    ...
    private void updateFinancialState() {
        ...
        oliverBankRef.child("Line Of Credit Issued Capital Amount USD").setValue(new_issued_capital_amount_st);
        oliverBankRef.child("Line Of Credit Current Capital Amount USD").setValue(new_current_capital_amount_st);
        oliverBankRef.child("Line Of Credit Total Future Value Amount USD").setValue(new_total_future_value_amount_st);
        oliverBankRef.child("Line Of Credit Current Future Value Amount USD").setValue(new_current_future_value_amount_st);
        oliverBankRef.child("Line Of Credit Total Interest Amount USD").setValue(new_total_interest_amount_accumulated_st);
        oliverBankRef.child("Line Of Credit Current Interest Amount USD").setValue(new_current_interest_amount_st);
        oliverBankRef.child("Line Of Credit Rate Accumulated USD").setValue(new_rate_accumulated_st);
        oliverBankRef.child("Line Of Credit Transactions Number USD").setValue(new_transactions_number_st);
        oliverBankRef.child("Line Of Credit Number of Quotes USD").setValue(new_number_of_quotes_st);
    ...
    private void registerOperation() {
        ...
        myOperationsRef.child(currentUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            @Override
            public void onComplete(@NonNull Task task) {
                Intent intent = new Intent(LineOfCreditUseUsdActivity.this, CreditLineUseCompletedActivity.class);
    ...
    private void generateBills() {
        ...
        for (int i = 1; i <= quotes_number; i++) {
            ...
            userRef.child(currentUserID).child("Line Of Credit Bills USD").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.hasChild(current_year+""+current_month)) {
                        ...
                        userRef.child(currentUserID).child("Line Of Credit Bills USD").child(current_year+""+current_month).child("quote_amount").setValue(quote_amount_st);
                        userRef.child(currentUserID).child("Line Of Credit Bills USD").child(current_year+""+current_month).child("fixed_quote").setValue(quote_amount_st);
                        userRef.child(currentUserID).child("Line Of Credit Bills USD").child(current_year+""+current_month).child("capital_amount").setValue(capital_amount_st);
                        userRef.child(currentUserID).child("Line Of Credit Bills USD").child(current_year+""+current_month).child("monthly_interest").setValue(monthly_interes_st);
                        ...
                        userRef.child(currentUserID).child("Line Of Credit Bills USD").child(current_year+""+current_month).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                            @Override
                            public void onComplete(@NonNull Task task) {
