...
public class LineOfCreditTotalPaymentActivity extends AppCompatActivity {
    ...
    String currentUserID,credit_line_pen_total,credit_line_pen_used,credit_line_pen_available,basic_account_pen,basic_account_usd,currency_rate_sell,currency_rate_buy,credit_line_image,postKey,
            ...
            rate_accumulated,transactions_number,number_of_quotes,ammount_df,email,name,end_day,end_month,end_year,saveCurrentDate,saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_of_credit_total_payment);
                                ...
                                imageResourses.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.exists())
                                        {
                                            ...
                                            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).addListenerForSingleValueEvent(new ValueEventListener() {
                                                @Override
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    ...
                                                    txtQuoteAmount.setText("S/"+total_amount_to_pay_st);
    ...
    private void registerOperation() {
        ...
        myOperationsRef.child(currentUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                sendEmail();
                Intent intent = new Intent(LineOfCreditTotalPaymentActivity.this, LineOfCreditPayActivity.class);
                loadingBar.dismiss();
                Toasty.success(LineOfCreditTotalPaymentActivity.this, "PAGO EXITOSO!", Toast.LENGTH_LONG).show();
    ...
    private void sendEmail() {
        ...
        String message = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "<div style=\"color:#555555;font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;\">\n" +
                "<div style=\"line-height: 2; font-size: 12px; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #555555; mso-line-height-alt: 24px;\">\n" +
                "<p style=\"font-size: 14px; line-height: 2; word-break: break-word; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 28px; margin: 0;\"><span style=\"color: #000080;\">S/ "+quote_amount+"</span></p>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "<!--<![endif]-->\n" +
                ...
                "<div style=\"color:#555555;font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;\">\n" +
                "<div style=\"line-height: 2; font-size: 12px; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #555555; mso-line-height-alt: 24px;\">\n" +
                "<p style=\"font-size: 14px; line-height: 2; word-break: break-word; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 28px; margin: 0;\"><span style=\"color: #000080;\">Línea de Crédito Digital Soles</span></p>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "<!--<![endif]-->\n" +
                ...
                "<div style=\"color:#555555;font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;\">\n" +
                "<div style=\"line-height: 2; font-size: 12px; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #555555; mso-line-height-alt: 24px;\">\n" +
                "<p style=\"font-size: 14px; line-height: 2; word-break: break-word; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 28px; margin: 0;\"><span style=\"color: #000080;\">S/ "+desgravamen_insurrance+"</span></p>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "<!--<![endif]-->\n" +
                ...
                "<div style=\"color:#555555;font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;\">\n" +
                "<div style=\"line-height: 2; font-size: 12px; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #555555; mso-line-height-alt: 24px;\">\n" +
                "<p style=\"font-size: 14px; line-height: 2; word-break: break-word; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 28px; margin: 0;\"><span style=\"color: #000080;\">Mes pagado:</span></p>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "<!--<![endif]-->\n" +
        ...
        JavaMailAPI javaMailAPI = new JavaMailAPI(LineOfCreditTotalPaymentActivity.this, email.trim(),subject,message);
        javaMailAPI.execute();
    }
    ...
    private void doThePayment() {
        ...
        if (rdPenAccount.isChecked()) {
            ...
            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).child("quote_amount").setValue("0.00");
            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).child("capital_amount").setValue("0.00");
            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).child("monthly_interest").setValue("0.00");
            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).child("desgravamen_insurrance").setValue("0.00");
            userRef.child(currentUserID).child("Line Of Credit Bills").child(postKey).child("debt_state").setValue("1");
        }
        if (rdUsdAccount.isChecked()) {
