...
public class CreditLineCompanyPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_line_company_pay);
        ...
        userRef.child(currentUserID).addValueEventListener(new ValueEventListener() {
                ...
                oliverBankRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            credit_line_to_chage_now = dataSnapshot.child("Company Credit Line Amount to Charge Now PEN").getValue().toString();
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(CreditLineCompanyPayActivity.this, "ERROR AL CARGAR", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentCreditLine() {
        ...
        hashMap.put("current_account_pen",ammount_in_account_st);
        ...
        userRef.child(currentUserID).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if (task.isSuccessful())
                {
                    ...
                    oliverBankRef.child("Company Credit Line Amount to Charge Now PEN").setValue(real_amount_tocharge_st);
                    registerOperation();
                }
            }
        });
    ...
    private void registerOperation() {
        ...
        //Credit Line Payment
        myOperationMap.put("credit_payment_ammount",edtAmmount.getText().toString()+" PEN");
        ...
        myOperationsRef.child(currentUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            @Override
            public void onComplete(@NonNull Task task) {
                Intent intent = new Intent(CreditLineCompanyPayActivity.this, InvesmentFundTransactionCompletedActivity.class);
