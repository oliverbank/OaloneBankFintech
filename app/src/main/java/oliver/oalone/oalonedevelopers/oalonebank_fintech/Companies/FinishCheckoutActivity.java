...
public class FinishCheckoutActivity extends AppCompatActivity {
        ...
        userRef.child(senderUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    Picasso.with(FinishCheckoutActivity.this).load(my_profileimage).fit().centerCrop().into(myProfileImage);
        ...
        companiesRef.child(receiverUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    Picasso.with(FinishCheckoutActivity.this).load(user_profileimage).fit().centerCrop().into(userProfileImage);
    ...
    private void registerUserOperation() {
        ...
        companiesOperationsRef.child(receiverUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if (task.isSuccessful())
                {
                    Intent intent = new Intent(FinishCheckoutActivity.this, SucessfullPaymentActivity.class);
