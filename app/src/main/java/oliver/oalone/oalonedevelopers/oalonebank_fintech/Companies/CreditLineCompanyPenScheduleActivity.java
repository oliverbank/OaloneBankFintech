...
public class CreditLineCompanyPenScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_line_company_pen_schedule);
        ...
        userRef.child(currentUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtQuoteAmmount1.setText("S/ "+credit_line_pen_payment_month1);
                txtQuoteAmmount2.setText("S/ "+credit_line_pen_payment_month2);
                txtQuoteAmmount3.setText("S/ "+credit_line_pen_payment_month3);
                txtQuoteAmmount4.setText("S/ "+credit_line_pen_payment_month4);
                txtQuoteAmmount5.setText("S/ "+credit_line_pen_payment_month5);
                txtQuoteAmmount6.setText("S/ "+credit_line_pen_payment_month6);
                txtQuoteAmmount7.setText("S/ "+credit_line_pen_payment_month7);
                txtQuoteAmmount8.setText("S/ "+credit_line_pen_payment_month8);
                txtQuoteAmmount9.setText("S/ "+credit_line_pen_payment_month9);
                txtQuoteAmmount10.setText("S/ "+credit_line_pen_payment_month10);
                txtQuoteAmmount11.setText("S/ "+credit_line_pen_payment_month11);
                txtQuoteAmmount12.setText("S/ "+credit_line_pen_payment_month12);
            }
