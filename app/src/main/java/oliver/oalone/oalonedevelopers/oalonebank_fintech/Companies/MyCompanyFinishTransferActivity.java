...
public class MyCompanyFinishTransferActivity extends AppCompatActivity {
    ...
    private DatabaseReference userRef,ratesRef,myOperationsRef,imageResourses,myCompanyRef,myCompanyOperationsRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_company_finish_transfer);
        ...
        myCompanyRef.child(my_company_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    Picasso.with(MyCompanyFinishTransferActivity.this).load(my_profileimage).fit().into(myProfileImage);
        ...
        userRef.child(receiverUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    Picasso.with(MyCompanyFinishTransferActivity.this).load(user_profileimage).fit().into(userProfileImage);
    ...
    private void registerOperation() {
        ...
        myOperationMap.put("uid",my_company_key);
        ...
        myCompanyOperationsRef.child(my_company_key+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            @Override
    ...
    private void registerUserOperation() {
        ...
        myOperationsRef.child(receiverUserID+operationRandomName).updateChildren(myOperationMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if (task.isSuccessful())
                {
                    Intent intent = new Intent(MyCompanyFinishTransferActivity.this, InvesmentFundTransactionCompletedActivity.class);
    ...
    private void updateMyAccount() {
        ...
        myCompanyRef.child(my_company_key).updateChildren(update).addOnCompleteListener(new OnCompleteListener() {
            @Override
            public void onComplete(@NonNull Task task) {
                updateUserAccount();
            }
