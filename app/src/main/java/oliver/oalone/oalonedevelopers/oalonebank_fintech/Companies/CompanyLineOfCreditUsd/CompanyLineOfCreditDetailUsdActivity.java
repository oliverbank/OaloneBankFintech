...
import oliver.oalone.oalonedevelopers.oalonebank_fintech.LineOfCreditUsd.LineOfCreditScheduleUsdActivity;
...
public class CompanyLineOfCreditDetailUsdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_line_of_credit_detail_usd);
        ...
        btnUseCreditPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CompanyLineOfCreditDetailUsdActivity.this, CompanyLineOfCreditUseUsdActivity.class);
        ...
        btnPayLineOfCredit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CompanyLineOfCreditDetailUsdActivity.this, CompanyLineOfCreditPayUsdActivity.class);
                intent.putExtra("my_company_key",my_company_key);
                startActivity(intent);
            }
        });
        ...
        btnSchedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CompanyLineOfCreditDetailUsdActivity.this, CompanyLineOfCreditScheduleUsdActivity.class);
                intent.putExtra("my_company_key",my_company_key);
                startActivity(intent);
            }
        });
        ...
        FirebaseRecyclerAdapter<MyOperationsModel, myPostViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<MyOperationsModel, myPostViewHolder>
            ...
            protected void populateViewHolder(myPostViewHolder viewHolder, MyOperationsModel model, int position) {
                ...
                if (viewHolder.operation_code.equals("CL"))
                {
                    ...
                    viewHolder.txtSymbol.setTextColor(ContextCompat.getColor(CompanyLineOfCreditDetailUsdActivity.this, R.color.redColor));
                    viewHolder.txtAmount.setTextColor(ContextCompat.getColor(CompanyLineOfCreditDetailUsdActivity.this, R.color.redColor));
                }
                if (viewHolder.operation_code.equals("PC"))
                {
                    ...
                    viewHolder.txtSymbol.setTextColor(ContextCompat.getColor(CompanyLineOfCreditDetailUsdActivity.this, R.color.greenColor));
                    viewHolder.txtAmount.setTextColor(ContextCompat.getColor(CompanyLineOfCreditDetailUsdActivity.this, R.color.greenColor));
                }
