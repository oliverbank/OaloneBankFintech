...
public class CreditLineCompanyRequestApprovedDetailsActivityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_line_company_request_approved_details_activity);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CreditLineCompanyRequestApprovedDetailsActivityActivity.this, CreditLineCompanyContractActivity.class);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                userRef.child(currentUserID).updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        loadingBar.dismiss();
                        Intent intent = new Intent(CreditLineCompanyRequestApprovedDetailsActivityActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
