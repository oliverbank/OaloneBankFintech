...
public class IndependentWorkerExpressLoanRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_independent_worker_express_loan_request);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    return new ReceiptsForFeesFragment();
                case 3:
                    return new AnnualIncomeTaxReturnFragment();
                case 4:
                    return new IndependentWorkerSumaryLoanRequestFragment();
