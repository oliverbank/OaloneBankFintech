...
import oliver.oalone.oalonedevelopers.oalonebank_fintech.PersonalLendings.RequestPersonalLendingTypeActivity;
import oliver.oalone.oalonedevelopers.oalonebank_fintech.R;

public class MyCompanyReceiverPersonalLendingActivity extends AppCompatActivity {

    RecyclerView myPostList;
    private FirebaseAuth mAuth;
    private DatabaseReference postsRef,userRef,ratesRef,myOperationsRef,imageResourses,companyRef,myCompanyOperationsRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_company_receiver_personal_lending);
        ...
        myCompanyOperationsRef = FirebaseDatabase.getInstance().getReference().child("My Company Operations");
        ...
        btnMyLendings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MyCompanyReceiverPersonalLendingActivity.this, RequestPersonalLendingTypeActivity.class);
            ...
            protected void populateViewHolder(final myPostViewHolder viewHolder, PersonalLendingModel model, final int position) {
                ...
                companyRef.child(viewHolder.sender_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Picasso.with(MyCompanyReceiverPersonalLendingActivity.this).load(profileimage).fit().centerCrop().into(viewHolder.imageUser);
                            viewHolder.txtUsername.setText(username);
                            viewHolder.txtDni.setText("RUC: "+document_number);
                ...
                viewHolder.btnConfirm.setOnClickListener(new View.OnClickListener() {
                    ...
                    private void registerOperation() {
                        ...
                        myOperationMap.put("operation_type","Préstamo de Institución Financiera o Empresa");
                ...
                viewHolder.btnShowDetails.setOnClickListener(new View.OnClickListener() {
                    ...
                    private void showDetailsDialog() {
                        final AlertDialog.Builder dialog = new AlertDialog.Builder(MyCompanyReceiverPersonalLendingActivity.this);
                        dialog.setCancelable(false);

                        LayoutInflater inflater = LayoutInflater.from(MyCompanyReceiverPersonalLendingActivity.this);
                        ...
                        double months_number = Double.parseDouble(financing_months);
                        double quotes_number = months_number/finance_frec;
                ...
                viewHolder.btnShowBills.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(MyCompanyReceiverPersonalLendingActivity.this, CompanyPersonalLendingBillsActivity.class);
