...
public class DependentWorkerExpressLoanRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dependent_worker_express_loan_request);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    return new JobIncomesFragment();
                case 3:
                    return new SumaryLoanDependentWorkerRequestFragment();
